<template>
    <div class="container">
      <div class="delete" v-if="deleteAccount">
        <div class="wrapper fadeInDown">
          <div id="formContent">
            <h2 class="delete" v-if="!modePassword">DELETE PROFILE</h2>
           
            <form v-on:submit.prevent="deleteCompte()">
              <input
                type="text"
                id="password"
                name="login"
              ...
              <button class="btn btn-danger mt-3 mb-5" @click="deleteCompte()">
                DELETE
              </button>
            </form>
          </div>
          ...
          <div id="formContent">
            ...
            <form v-on:submit.prevent="modifier, changePassword">
              ...
              <input
                ...
                id="desc"
                name="desc"
                placeholder="Job at Groupomania"
              />
              <p class="red app" v-if="long && !modePassword">
                Fields must be at least 3 characters.
              </p>
              <input
                v-if="modePassword"
                type="password"
  ...
  .app {
    animation: disappearance 3.5s forwards;
  }
  .red {
    color: red;
    margin: 0px;
